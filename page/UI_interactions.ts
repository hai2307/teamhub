...
export async function generateRandomString(length: number):  Promise<void> {
...
// Hàm Để Chờ Đợi Một Phần Tử Được Tải
...
//   const frame: Frame = await page.frame({ url: iframeSelector });
