...
export class cd_quytrinhnghiviec {
  readonly page: Page
  readonly caidat:Locator
  readonly caidat_quytrinhnghiviec:Locator 
  readonly Dev: Locator
  readonly HR: Locator
  readonly Tester: Locator
  readonly dscongviecchung: Locator
  ...
  constructor(page: Page) {
    ...
    this.caidat_quytrinhnghiviec = page.getByRole('list').getByRole('link', { name: 'Quy trình gia nhập' })
    this.dscongviecchung=page.getByRole('button', { name: 'Danh sách công việc chung cho' })
  ...
  async gotoCaidat_quitrinhnghiviec() {
    await this.caidat.click() 
    await this.caidat_quytrinhnghiviec.click() 
