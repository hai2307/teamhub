...
export class Dropdown {
  async clickDropdownPopup(page: Page, text1: string, text2: string) {
    await page.click(DYNAMIC_ELEMENT.PLACEHOLDER_POPUP(text2, text1));
  }

  async checkItemDropdown(page: Page, text1: string, text2: string) {
    await page.isEnabled(DYNAMIC_ELEMENT.ITEM_DROPDOWN(text2, text1));
  }
